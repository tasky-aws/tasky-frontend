...
module.exports = configure(function (ctx) {
  return {
    ...
    framework: {
      ...
      components: ['QBtn', 'QIcon', 'QFab', 'QFabAction', 'QDrawer', 'QHeader', 'QToolbar', 'QScrollArea', 'QList'],
      directives: ['Ripple', 'TouchPan', 'TouchSwipe'],

      // Quasar plugins
      plugins: ['Notify', 'BottomSheet', 'AddressbarColor', 'Loading']
    },
    ...
    pwa: {
      ...
      manifest: {
        name: 'tasky',
        short_name: 'tasky',
        description: 'a frontend for the tasky application',
        display: 'standalone',
